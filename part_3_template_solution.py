...
class Section3:
    ...
    def partB(
        ...
        max_Xtest = Xtest.max()
        print(
            f"3B - The lengths of Xtrain, Xtest, ytrain, ytest is: {length_Xtrain}, {length_Xtest}, {length_ytrain}, {length_ytest}")
    ...
    def partC(
        ...
        answer[
            'explain_is_precision_higher_than_recall'] = "The model demonstrates greater precision than recall, indicating a stronger capability in accurately identifying true positive cases among all positive predictions. This scenario often occurs in datasets with an uneven class distribution, where the model is better at reducing the occurrence of false positives compared to minimizing false negatives. Essentially, the model is more successful at ensuring the positive predictions it makes are correct, rather than capturing every instance of actual positives"
